...
to `gateware/probes/usb_serial/usb_serial.py` -- same AUX ULPI PHY, same 60 MHz
...
Build and flash:
    ...
    CynthionPlatformRev1D4().build(USBBulkLoopback(), do_program=False,
                                   build_dir='gateware/probes/usb_bulk/build')"
    apollo configure gateware/probes/usb_bulk/build/top.bit
"""
...
# From the central allocation in gateware/usb_ids.py, never a locally chosen number.
#
