...
it to go, which is the point.
    ...
    ./gateware/probes/loader/bitstream_sink.py --build
    ./gateware/probes/loader/bitstream_sink.py --build --program
...
def main():
    ...
    # luna-soc stack behind it. See gateware/board/core.py.
