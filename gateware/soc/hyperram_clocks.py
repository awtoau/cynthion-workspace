...
`DPHASE_SOURCE="ENABLED"` and the five phase ports driven from fabric, instead of
tied off. `peripherals/pll_phase.py` is the CSR the CPU writes; the arithmetic
and the silicon rules are here.
    ...
    def elaborate(self, platform):
        ...
        m.submodules.pll = Instance(
            ...
            **({"a_BEL": "X2/Y49/EHXPLL_LL"} if self.dqs else {}),
            ...
            p_STDBY_ENABLE="DISABLED", p_DPHASE_SOURCE="ENABLED",
