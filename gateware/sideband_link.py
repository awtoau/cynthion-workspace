...
query for a capability it does not have. `gateware/probes/sideband/sideband_gateware.py`
...
bit-banged. Measured with `gateware/probes/adv_speed/`, which streams a counting
