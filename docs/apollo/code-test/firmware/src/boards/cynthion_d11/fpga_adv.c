...
void fpga_adv_task(void)
{
	...
	// Disable the EIC IRQ to atomically read and clear edge_counter;
	// without this, EIC_Handler can fire between the read and the clear,
	// losing edges that arrived in the window.
