...
```
Family name="ECP5U"      text="sa5p00"      <- the Cynthion part
...
Cynthion devices. `ispfpga/ep5c00/data/` contains **no `LFE5U` file at all**.

| tree | family |
|---|---|
| **`sa5p00`** | **ECP5U — the Cynthion part (LFE5U-12F/25F)** |
...
45 `.con` files, one per part+package, including every Cynthion-relevant
...
(16 MB each, dated 2024).** Note `sa5p25` is the LFE5U-25F die — the Cynthion
part.
