...
Current SoC, `tmp/soc/build/top.tim` (2026-08-03T00:25, LFE5U-12F,
CABGA256, speed 8):
...
(`soc/top.py:958`) and `control_phy` is shared with Apollo. It is also
...
- `platform.request("target_phy")` may be called once. `soc/top.py:1288-1298`
...
`gateware/soc/peripherals/stream_buffer.py:96`, in use at `soc/top.py:988-991`.
...
PLIC source 6 (`Plic(sources=5)` → `6` at `soc/top.py:650`; sources 1-5
...
*inside* `CynthionSoC` and read the in-situ LUT count and `sync`/`usb` fmax. §12's
...
1. **Mux `target_phy`.** Move the pad wiring at `soc/top.py:1288-1298`
