...
* [`soc-concurrency-models.md`](https://github.com/awtoau/cynthion-workspace/blob/main/docs/soc-concurrency-models.md) — the model comparison
* [`soc-workload-and-preemption.md`](https://github.com/awtoau/cynthion-workspace/blob/main/docs/soc-workload-and-preemption.md) — a device-emulation load, and preemption measured against it
* [`rtic-usb-port.md`](https://github.com/awtoau/cynthion-workspace/blob/main/docs/rtic-usb-port.md) — real moondancer control transfers running on RTIC
* [`rtic-adoption.md`](https://github.com/awtoau/cynthion-workspace/blob/main/docs/rtic-adoption.md) — the original RTIC plan
