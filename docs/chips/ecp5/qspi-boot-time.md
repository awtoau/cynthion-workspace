...
(see [`../chips/w25q32-config-flash.md`](../w25q32-config-flash.md), where 80 MHz worked but was
...
[`../chips/w25q32-config-flash.md`](../w25q32-config-flash.md) records **user-mode** reads from
