...
Current whole-SoC build, `tmp/soc/build/top.tim` (2026-08-03, LFE5U-12F,
...
**Build `UsbOhciWishbone` inside `CynthionSoC` and read the numbers. No board, no
firmware, no wiring.**
...
|---|---|---|
| SoC today (`tmp/soc/build/top.tim`) | 12201 (50%) | 42 (75%) |
