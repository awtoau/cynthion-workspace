...
stdout+stderr lands in tmp/logs/check-<name>.log for post-mortem. A run
first deletes any check-<name>.log whose check no longer exists, so a
retired check's last output cannot be mistaken for a current result.
"""
