...
REQUIRED_MARKERS = (
    ...
    # Variable latency, both counts, at the two ends of the sparse code table.
    # `fix` and `var` differ by L, so a controller that takes the wrong branch
    # misses the whole burst -- which is what #338 measures on the board.
