...
# Must match gateware/soc/top.py -- FLASH_BASE, FLASH_CSR_BASE
...
/* An NS16550A -- Uart16550 in gateware/soc/peripherals/uart16550.py, and byte-identical
...
/* Chip select hold, a LATCHING register at offset 0x20 -- see
   HoldableSPIController in gateware/soc/peripherals/flash.py.
...
/* ------------------------------------------------------------------------
   ...
   See FlashPinProbe in gateware/soc/peripherals/flash.py.
...
def main():
    ...
    emit()
    emit("next: ./gateware/soc/top.py --build --program")
